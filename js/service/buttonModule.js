...
( function( pacManApp ){
    ...
    pacManApp.service.buttonModule = function( parentId, 
                                               options, 
                                               callbacks ) {
        // PRIVATE:
        ...
        // FUNCTION: addHtml( void ) void
            ...
            pacManApp.appendContainer( self.parentId, self.options );
        ...
        // FUNCTION: removeHtml( void ) void
            ...
            // remove container
            pacManApp.getElementById( self.options['id'] ).remove();
        ...
        // FUNCTION: addBasicEvents( void ) void
            ...
            if( self.callbacks['mouseOver'] !== undefined ){
                ...
                // add mouse over
                pacManApp.getElementById( self.options['id'] ).addEventListener( 'mouseover' , self.mouseOver ); 
            ...
            if( self.callbacks['mouseOut'] !== undefined ){
                ...
                // add mouse out
                pacManApp.getElementById( self.options['id'] ).addEventListener( 'mouseout' , self.mouseOut ); 
            ...
            if( self.callbacks['click'] !== undefined ){
                ...
                // add click
                pacManApp.getElementById( self.options['id'] ).addEventListener( 'click' , self.click ); 
        ...
        // FUNCTION: addKeyUp( void ) void
            ...
            if( self.callbacks['keyUp'] !== undefined ){
                ...
                // add key up 
                pacManApp.getElementById( self.options['id'] ).addEventListener( 'keyup' , self.keyUp ); 
            ...
            if( self.callbacks['keyDown'] !== undefined ){
                ...
                // add key down
                pacManApp.getElementById( self.options['id'] ).addEventListener( 'keydown' , self.keyDown ); 
        ...
        // FUNCTION: removeBasicEvents( void ) void
            ...
            if( self.callbacks['mouseOver'] !== undefined ){
                ...
                // add mouse over
                pacManApp.getElementById( self.options['id'] ).removeEventListener( 'mouseover' , self.mouseOver ); 
            ...
            if( self.callbacks['mouseOut'] !== undefined ){
                ...
                // add mouse out
                pacManApp.getElementById( self.options['id'] ).removeEventListener( 'mouseout' , self.mouseOut ); 
            ...
            if( self.callbacks['click'] !== undefined ){
                ...
                // add click
                pacManApp.getElementById( self.options['id'] ).removeEventListener( 'click' , self.click ); 
        ...
        // FUNCTION: removeKeyEvents( void ) void
            ...
            if( self.callbacks['keyUp'] !== undefined ){
                ...
                // add key up 
                pacManApp.getElementById( self.options['id'] ).removeEventListener( 'keyup' , self.keyUp ); 
            ...
            if( self.callbacks['keyDown'] !== undefined ){
                ...
                // add key down
                pacManApp.getElementById( self.options['id'] ).removeEventListener( 'keydown' , self.keyDown ); 
        ...
        // FUNCTION: highlight( void ) void
            ...
            if( self.options['images'] !== undefined &&
                ...
                pacManApp.getElementById( self.options['id'] ).style.backgroundImage = self.options['images']['highlight'];
            ...
            if( self.options['colors'] !== undefined ){
                ...
                if( colors['highlight'] !== undefined ){
                    ...
                    // set color highlight 
                    pacManApp.getElementById( self.options['id'] ).style.color = colors['highlight'];
                ...
                if( colors['background'] !== undefined &&
                    ...
                    pacManApp.getElementById( self.options['id'] ).style.backgroundColor = colors['background']['highlight'];
                ...
                if( colors['border'] !== undefined &&
                    ...
                    pacManApp.getElementById( self.options['id'] ).style.borderColor = colors['border']['highlight'];
        ...
        // FUNCTION: showDisabled( void ) void
            ...
            if( self.options['images'] !== undefined &&
                ...
                // set disabled image
                pacManApp.getElementById( self.options['id'] ).style.backgroundImage = self.options['images']['disabled'];
            ...
            if( self.options['colors'] !== undefined ){
                ...
                if( colors['disabled'] !== undefined ){
                    ...
                    // set color disabled 
                    pacManApp.getElementById( self.options['id'] ).style.color = colors['disabled'];
                ...
                if( colors['background'] !== undefined &&
                    ...
                    pacManApp.getElementById( self.options['id'] ).style.backgroundColor = colors['background']['disabled'];
                ...
                if( colors['border'] !== undefined &&
                    ...
                    pacManApp.getElementById( self.options['id'] ).style.borderColor = colors['border']['disabled'];
        ...
        // FUNCTION: reset( void ) void
            ...
            if( self.options['images'] !== undefined &&
                ...
                // set image url 
                pacManApp.getElementById( self.options['id'] ).style.backgroundImage = self.options['images']['image'];
            ...
            if( self.options['colors'] !== undefined ){
                ...
                if( colors['color'] !== undefined ){
                    ...
                    // set color
                    pacManApp.getElementById( self.options['id'] ).style.color = colors['color'];
                ...
                if( colors['background'] !== undefined &&
                    ...
                    pacManApp.getElementById( self.options['id'] ).style.backgroundColor = colors['background']['color'];
                ...
                if( colors['border'] !== undefined &&
                    ...
                    // set border color
                    pacManApp.getElementById( self.options['id'] ).style.borderColor = colors['border']['color'];
