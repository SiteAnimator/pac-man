...
( function( pacManApp ){
    ...
    // create name space
    pacManApp.game.about.background = pacManApp.game.about.background ? pacManApp.game.about.background : {};
    
    pacManApp.game.about.background.backgroundModule = function( parentId ) {
        // PRIVATE:
