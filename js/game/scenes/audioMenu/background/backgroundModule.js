...
( function( pacManApp ){
    ...
    // create name space
    pacManApp.game.audioMenu.background = pacManApp.game.audioMenu.background ? pacManApp.game.audioMenu.background : {};
    
    pacManApp.game.audioMenu.background.backgroundModule = function( parentId ) {
        // PRIVATE:
