/*
    ...
    file:       audioMenuModule.js
    function:   handels displaying the level screen
...
( function( pacManApp ){
    ...
    // MODULE: audioMenuModule( string: sceneId,
    //                          html element id: parentId
    //                          named array: callbacks ) named array
        
    // create name space
    pacManApp.game.audioMenu = pacManApp.game.audioMenu ? pacManApp.game.audioMenu : {};
    
    pacManApp.game.audioMenu.audioMenuModule = function( sceneId,
                                                         parentId,
                                                         callbacks ) {
        // PRIVATE:
        ...
        self.MODULE = 'AudioMenuModule';                    // string
        ...
        self.containerOptions = {                           // named array 
            ...
            'styleWidth'            :   '100%',             // css
            'styleHeight'           :   '100%',             // css
            'backgroundColor'       :   pacManApp.getColor( 'audioMenu', 'background' ), // css
            'opacity'               :   0.0,                // css
        ...
        // FUNCTION: createBackground( void ) void
            ...
            let backgroundModule = pacManApp.game.audioMenu.background.backgroundModule;
    ...
    // DONE MODULE: audioMenuModule( string: sceneId,
    //                               html element id: parentId
    //                               named array: callbacks ) named array
