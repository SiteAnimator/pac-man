...
( function( pacManApp ){
    ...
    // create name space
    pacManApp.game.levelSelection.background = pacManApp.game.levelSelection.background ? pacManApp.game.levelSelection.background : {};
    
    pacManApp.game.levelSelection.background.backgroundModule = function( parentId ) {
        // PRIVATE:

        // MEMBERS:
        var self = this;                                    // object
        self.debugOn = true;                               // boolean
        self.MODULE = 'LevelSelectionBackgroundModule';     // string
