/*
    ...
    file:       levelSelectionModule.js
    function:   handels displaying the level selection screen
...
( function( pacManApp ){
    ...
    // MODULE: levelSelectionModule( string: sceneId,
    //                               html element id: parentId
    //                               named array: callbacks ) named array
        
    // create name space
    pacManApp.game.levelSelection = pacManApp.game.levelSelection ? pacManApp.game.levelSelection : {};
    
    pacManApp.game.levelSelection.levelSelectionModule = function( sceneId,
                                                                   parentId,
                                                                   callbacks ) {
        // PRIVATE:
        ...
        self.MODULE = 'LevelSelectionModule';               // string
        ...
        self.containerOptions = {                           // named array 
            ...
            'styleWidth'            :   '100%',             // css
            'styleHeight'           :   '100%',             // css
            'backgroundColor'       :   pacManApp.getColor( 'levelSelection', 'background' ), // css
            'opacity'               :   0.0,                // css
        ...
        // FUNCTION: createBackground( void ) void
            ...
            let backgroundModule = pacManApp.game.levelSelection.background.backgroundModule;
    ...
    // DONE MODULE: levelSelectionModule( string: sceneId,
    //                                    html element id: parentId
    //                                    named array: callbacks ) named array
