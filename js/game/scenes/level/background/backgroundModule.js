...
( function( pacManApp ){
    ...
    // create name space
    pacManApp.game.level.background = pacManApp.game.level.background ? pacManApp.game.level.background : {};
    
    pacManApp.game.level.background.backgroundModule = function( parentId ) {
        // PRIVATE:

        // MEMBERS:
        var self = this;                                    // object
        self.debugOn = true;                               // boolean
        self.MODULE = 'LevelBackgroundModule';              // string
