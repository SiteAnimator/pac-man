...
( function( pacManApp ){
    ...
    // MODULE: levelModule( string: sceneId,
    //                     html element id: parentId
    //                     named array: callbacks ) named array
        
    // create name space
    pacManApp.game.level = pacManApp.game.level ? pacManApp.game.level : {};
    
    pacManApp.game.level.levelModule = function( sceneId,
                                                 parentId,
                                                 callbacks ) {
        // PRIVATE:
        ...
        self.MODULE = 'LevelModule';                        // string
        ...
        self.containerOptions = {                           // named array 
            ...
            'styleWidth'            :   '100%',             // css
            'styleHeight'           :   '100%',             // css
            'backgroundColor'       :   pacManApp.getColor( 'level', 'background' ), // css
            'opacity'               :   0.0,                // css
        ...
        // FUNCTION: createBackground( void ) void
            ...
            let backgroundModule = pacManApp.game.level.background.backgroundModule;
    ...
    // DONE MODULE: levelModule( string: sceneId,
    //                           html element id: parentId
    //                           named array: callbacks ) named array
