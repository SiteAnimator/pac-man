...
( function( pacManApp ){
    ...
    // MODULE: menuModule( string: sceneId,
    //                     html element id: parentId
    //                     named array: callbacks ) named array
        
    // create name space
    pacManApp.game.menu = pacManApp.game.menu ? pacManApp.game.menu : {};
    
    pacManApp.game.menu.menuModule = function( sceneId,
                                               parentId,
                                               callbacks ) {
        // PRIVATE:
        ...
        self.containerOptions = {                           // named array 
            ...
            'styleWidth'            :   '100%',             // css
            'styleHeight'           :   '100%',             // css
            'backgroundColor'       :   pacManApp.getColor( 'menu', 'background' ), // css
            'opacity'               :   0.0,                // css
        ...
        // FUNCTION: createBackground( void ) void
            ...
            let backgroundModule = pacManApp.game.menu.background.backgroundModule;
