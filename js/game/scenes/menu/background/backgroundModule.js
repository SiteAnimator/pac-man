...
( function( pacManApp ){
    ...
    // create name space
    pacManApp.game.menu.background = pacManApp.game.menu.background ? pacManApp.game.menu.background : {};
    
    pacManApp.game.menu.background.backgroundModule = function( parentId ) {
        // PRIVATE:

        // MEMBERS:
        var self = this;                                    // object
        self.debugOn = true;                               // boolean
        self.MODULE = 'MenuBackgroundModule';               // string
