/*
    ...
    file:       gameDescriptionModule.js
    function:   handels displaying the game description screen
...
( function( pacManApp ){
    ...
    // MODULE: gameDescriptionModule( string: sceneId,
    //                                html element id: parentId
    //                                named array: callbacks ) named array
        
    // create name space
    pacManApp.game.gameDescription = pacManApp.game.gameDescription ? pacManApp.game.gameDescription : {};
    
    pacManApp.game.gameDescription.gameDescriptionModule = function( sceneId,
                                                                     parentId,
                                                                     callbacks ) {
        // PRIVATE:
        ...
        self.MODULE = 'GameDescriptionModule';              // string
        ...
        self.containerOptions = {                           // named array 
            ...
            'styleWidth'            :   '100%',             // css
            'styleHeight'           :   '100%',             // css
            'backgroundColor'       :   pacManApp.getColor( 'gameDescription', 'background' ), // css
            'opacity'               :   0.0,                // css
        ...
        // FUNCTION: createBackground( void ) void
            ...
            let backgroundModule = pacManApp.game.gameDescription.background.backgroundModule;
    ...
    // DONE MODULE: gameDescriptionModule( string: sceneId,
    //                                     html element id: parentId
    //                                     named array: callbacks ) named array
