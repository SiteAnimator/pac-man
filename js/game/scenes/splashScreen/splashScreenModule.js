/*
    ...
    file:       splashScreenModule.js
    function:   handels displaying the splash screen
...
( function( pacManApp ){
    ...
    // MODULE: splashScreenModule( string: sceneId,
    //                             html element id: parentId
    //                             named array: callbacks ) named array
        
    // create name space
    pacManApp.game.splashScreen = pacManApp.game.splashScreen ? pacManApp.game.splashScreen : {};
    
    pacManApp.game.splashScreen.splashScreenModule = function( sceneId,
                                                               parentId,
                                                               callbacks ) {
        // PRIVATE:
        ...
        self.containerOptions = {                           // named array 
            ...
            'text'                  :   'splash-screen',    // string
            'zIndex'                :   1,                  // css
            'position'              :   'absolute',         // css
            'styleWidth'            :   '100%',             // css
            'styleHeight'           :   '100%',             // css
            'backgroundColor'       :   pacManApp.getColor( 'splashScreen', 'background' ), // css
            'opacity'               :   0.0,                // css
        ...
        // FUNCTION: createBackground( void ) void
            ...
            let backgroundModule = pacManApp.game.splashScreen.background.backgroundModule;
        ...
        // FUNCTION: showReady( void ) void
            ...
            // create timer
            self.timerOptions['timerId'] = setTimeout( function () { self.ready(); }, self.timerOptions['delay']  );
    ...
    // DONE MODULE: splashScreenModule( string: sceneId,
    //                                  html element id: parentId
    //                                  named array: callbacks ) named array
