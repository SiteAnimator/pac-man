...
( function( pacManApp ){
    ...
    // create name space
    pacManApp.game.splashScreen.background = pacManApp.game.splashScreen.background ? pacManApp.game.splashScreen.background : {};
    
    pacManApp.game.splashScreen.background.backgroundModule = function( parentId ) {
        // PRIVATE:

        // MEMBERS:
        var self = this;                                    // object
        self.debugOn = true;                               // boolean
        self.MODULE = 'SplashScreenBackgroundModule';       // string
