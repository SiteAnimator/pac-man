/*
    ...
    file:       highScoresModule.js
    function:   handels displaying the menu screen
...
( function( pacManApp ){
    ...
    // MODULE: highScoresModule( string: sceneId,
    //                           html element id: parentId
    //                           named array: callbacks ) named array
        
    // create name space
    pacManApp.game.highScores = pacManApp.game.highScores ? pacManApp.game.highScores : {};
    
    pacManApp.game.highScores.highScoresModule = function( sceneId,
                                                           parentId,
                                                           callbacks ) {
        // PRIVATE:
        ...
        self.containerOptions = {                           // named array 
            ...
            'styleWidth'            :   '100%',             // css
            'styleHeight'           :   '100%',             // css
            'backgroundColor'       :   pacManApp.getColor( 'highScores', 'background' ), // css
            'opacity'               :   0.0,                // css
        ...
        // FUNCTION: createBackground( void ) void
            ...
            let backgroundModule = pacManApp.game.highScores.background.backgroundModule;
    ...
    // DONE MODULE: highScoresModule( string: sceneId,
    //                                html element id: parentId
    //                                named array: callbacks ) named array
