...
( function( pacManApp ){
    ...
    // create name space
    pacManApp.game.highScores.background = pacManApp.game.highScores.background ? pacManApp.game.highScores.background : {};
    
    pacManApp.game.highScores.background.backgroundModule = function( parentId ) {
        // PRIVATE:
